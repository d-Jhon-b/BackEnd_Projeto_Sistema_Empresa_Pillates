...
#     summary="[Instrutor/Colaborador] Deletar Registro de Aula Individual do Estudante."
# )
# async def delete_agenda_aluno_registro_endpoint(
#     registro_id: str,
#     agenda_aluno_ctrl: AgendaAlunoController = Depends(get_agenda_aluno_controller),
#     current_user: dict = Depends(auth_manager)
# ):
#     """
#     Deleta permanentemente um registro de aula do aluno (usado para cancelamentos/erros). 
#     Requer permissão de Admin/Instrutor.
#     """
#     await agenda_aluno_ctrl.delete_registro_agenda(
#         registro_id=registro_id,
#         current_user=current_user
#     )
#     return
